            ...
            <div class="ml-4 hidden max-w-md flex-1 md:flex">
                <div class="relative w-full">
                    ...
                    <input
                        ...
                        class="w-full rounded-2xl border border-white/70 bg-white/75 py-2.5 pl-10 pr-4 text-sm text-slate-600 shadow-sm shadow-slate-200/50 outline-none transition placeholder:text-slate-400 focus:border-sky-300 focus:bg-white focus:ring-4 focus:ring-sky-500/10"
                    >
                </div>
            </div>
        </div>
