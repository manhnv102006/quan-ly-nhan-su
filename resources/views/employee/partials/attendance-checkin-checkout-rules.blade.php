<div class="bg-sky-50 border border-sky-200 rounded-3xl p-5 sm:p-6">
    ...
    <ul class="text-xs text-sky-900 space-y-1.5 list-disc list-inside">
        ...
        <li>
            <strong>Nửa ngày lương</strong> = Lương hợp đồng ÷ Ngày công chuẩn ÷ 2
            (ví dụ lương 10.000.000₫, 23 ngày công → mỗi lần thiếu check-out trừ khoảng {{ number_format(10_000_000 / 23 / 2, 0, ',', '.') }}₫).
        </li>
    </ul>
</div>
