<x-accountant-layout title="Chi tiết kỳ lương">
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                ...
                <h3 class="text-3xl font-bold mt-2 text-amber-700">
        ...
        <div class="mt-8">
            @include('admin.partials.department-cards', [
                ...
                'routeName' => 'accountant.payroll-periods.department',
                    ...
                    <div class="relative border-l-2 border-slate-200 ml-4 space-y-8 py-2">
                        @foreach($activities as $activity)
                            <div class="relative pl-6">
                                <!-- Điểm mốc (dot) -->
                                <div class="absolute -left-[11px] top-1.5 w-5 h-5 rounded-full bg-amber-500 border-4 border-white shadow-sm"></div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-1 text-slate-700">
                                            ...
                                            @elseif($activity->event === 'calculate')
                                                <span class="inline-flex items-center gap-1.5 px-2 py-1 rounded bg-amber-50 text-amber-800 text-xs font-semibold">⚡ {{ $activity->description }}</span>
