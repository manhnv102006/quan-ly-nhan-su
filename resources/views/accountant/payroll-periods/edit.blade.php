<x-accountant-layout title="Sửa kỳ lương">
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('accountant.payroll-periods.index') }}"
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sm:p-8 max-w-3xl">
            ...
            <form action="{{ route('accountant.payroll-periods.update', $payrollPeriod) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select id="month" name="month" required
                                class="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition @error('month') border-red-400 @enderror disabled:bg-slate-50 disabled:text-slate-400 disabled:border-slate-200"
                    ...
                    <div>
                        ...
                        <select id="year" name="year" required
                                class="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition @error('year') border-red-400 @enderror disabled:bg-slate-50 disabled:text-slate-400 disabled:border-slate-200"
                                {{ $hasPayrolls ? 'disabled' : '' }}>
