<x-leader-layout title="Hợp đồng nhân viên" subtitle="Xem hợp đồng của nhân viên trong nhóm">
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Theo dõi hợp đồng của các thành viên trong nhóm.
                </p>
            </div>

            @if($expiringCount > 0)
                <a href="{{ route('leader.contracts.index', ['expiring' => 1]) }}"
        ...
        <div class="admin-card p-5">
            <form method="GET" class="flex flex-wrap gap-3">
                <input
                    ...
                    class="admin-field max-w-xs"
                    placeholder="Mã hợp đồng / tên nhân viên..."
                >
                        ...
                        @forelse($contracts as $item)
                            <tr class="hover:bg-slate-50/60">
                                ...
                                <td class="px-5 py-3 text-slate-600">
                                    {{ $item->contractType->contract_name ?? '—' }}
                                </td>
                                ...
                                <td class="px-5 py-3 text-center">
                                    <a
                                        href="{{ route('leader.contracts.show', $item) }}"
