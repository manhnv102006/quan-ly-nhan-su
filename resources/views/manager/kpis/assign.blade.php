...
>
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        {{-- Thông tin KPI gốc --}}
        <div class="bg-teal-50 rounded-2xl p-5 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 text-sm">
            ...
            <form action="{{ route('manager.kpis.store_assign', $assignment) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="employee_id" id="employee_id" required
                        class="w-full rounded-xl border border-slate-300 focus:border-teal-500 focus:ring-teal-500">
                ...
                <div>
                    ...
                    <textarea name="comment" id="comment" rows="3"
                        ...
                        class="w-full rounded-xl border border-slate-300 focus:border-teal-500 focus:ring-teal-500">{{ old('comment') }}</textarea>
                    @error('comment')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
