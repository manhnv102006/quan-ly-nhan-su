...
<body class="admin-body admin-shell" x-data="{ sidebarOpen: false }">
    ...
    <div class="relative flex min-h-screen overflow-x-hidden">
        <aside
            class="admin-sidebar fixed inset-y-0 left-0 z-50 flex h-screen w-[260px] shrink-0 transform flex-col transition-transform duration-200 lg:translate-x-0"
            :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        >
            <div class="flex items-center justify-between border-b border-slate-100 px-4 py-4">
                <div class="flex min-w-0 items-center gap-3">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-violet-100 bg-gradient-to-br from-violet-50 to-indigo-50 shadow-sm">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-[10px] font-semibold uppercase tracking-wider text-violet-600">Quản trị</p>
                    </div>
                </div>
        ...
        <div class="relative flex min-h-screen min-w-0 flex-1 flex-col lg:pl-[260px]">
            ...
            <main class="relative z-0 min-w-0 flex-1 p-4 lg:p-6">
                {{ $slot }}
            </main>
        </div>
    </div>
