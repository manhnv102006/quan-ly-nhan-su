    ...
    <div class="flex h-[76px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <div class="flex min-w-0 flex-1 items-center gap-4">
            <button
                ...
                class="rounded-xl p-2.5 text-slate-500 transition hover:bg-violet-50 hover:text-violet-600 lg:hidden"
            >
        ...
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            @if (($adminPending['total'] ?? 0) > 0)
                <a href="{{ $adminPendingUrl }}"
                   ...
                   class="relative inline-flex rounded-2xl border border-white/70 bg-white/70 p-2.5 text-slate-500 shadow-sm transition hover:bg-violet-50 hover:text-violet-700">
            ...
            <span class="hidden items-center gap-1.5 rounded-full bg-gradient-to-r from-violet-100 to-indigo-100 px-3 py-1.5 text-xs font-semibold text-violet-700 sm:inline-flex">
            ...
            <div class="flex items-center gap-2 pl-2 sm:border-l sm:border-slate-200/80 sm:pl-3">
                <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 via-indigo-500 to-cyan-400 text-sm font-bold text-white shadow-md shadow-violet-500/20 ring-2 ring-white">
