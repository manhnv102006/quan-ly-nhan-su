@php
    $menuItems = [
        ...
        [
            ...
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 .414-.336.75-.75.75h-4.5a.75.75 0 01-.75-.75v-4.25m0 0h4.125c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9m9 8.25H18M4.5 9.75h7.5m-7.5 3H9" />',
        ],
        [
...
@foreach ($menuItems as $item)
    ...
    <a
        ...
        class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
            {{ $active ? 'bg-white text-blue-800 shadow-sm' : 'text-blue-100 hover:bg-blue-700/60 hover:text-white' }}"
    >
        <svg class="w-5 h-5 shrink-0 {{ $active ? 'text-blue-600' : 'text-blue-200' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            {!! $item['icon'] !!}
        </svg>
