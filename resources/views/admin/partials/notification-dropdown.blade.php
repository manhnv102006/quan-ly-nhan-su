...
<div class="relative" x-data="{ open: false }" @click.outside="open = false">
    ...
    <div x-show="open"
         ...
         class="absolute right-0 top-full z-50 mt-2 w-[min(100vw-2rem,24rem)] origin-top-right"
         style="display: none;">
        <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-xl shadow-slate-200/60">
            ...
            <div class="border-t border-slate-100 bg-slate-50/80 px-4 py-3 text-center">
                <a href="{{ route('admin.notifications.index') }}"
                   class="text-xs font-semibold text-violet-600 hover:text-violet-700 transition">
