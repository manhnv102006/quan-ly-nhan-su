    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Tạo mới loại hợp đồng và thời hạn mặc định.</p>
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6">
            <form action="{{ route('admin.contract-types.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                    <label for="contract_name" class="block text-sm font-semibold text-slate-700">Tên loại hợp đồng</label>
                    <input type="text" id="contract_name" name="contract_name" value="{{ old('contract_name') }}"
                ...
                <div>
                    ...
                    <input type="number" id="duration_month" name="duration_month" value="{{ old('duration_month') }}"
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-violet-600 text-white font-medium hover:bg-violet-700 transition">Lưu loại hợp đồng</button>
                </div>
            </form>
        </div>
    </div>
