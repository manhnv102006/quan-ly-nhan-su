        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Theo dõi toàn bộ lịch phỏng vấn hiện có, ứng viên liên quan và kết quả hiện tại của từng buổi phỏng vấn.
                </p>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            ...
                            <th class="px-6 py-3 text-center text-xs font-bold uppercase text-slate-500">Kết quả</th>
                            <th class="px-6 py-3 text-left text-xs font-bold uppercase text-slate-500">Ghi chú</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($interviews as $interview)
                            <tr class="border-b border-slate-200 hover:bg-slate-50 transition">
                                ...
                                <td class="px-6 py-4 text-slate-600 max-w-sm">{{ $interview->note ?: 'Không có ghi chú' }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-12 text-slate-400">Chưa có lịch phỏng vấn nào trong hệ thống.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
