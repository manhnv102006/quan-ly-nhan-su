<x-admin-layout title="Thêm nhân viên mới">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6">
            <form action="{{ route('admin.employees.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                @csrf
...
+                           class="mt-1 w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-800 text-sm">
                ...
                <div class="md:col-span-2 flex items-center justify-end gap-3 mt-4">
                    ...
                    <button type="submit" class="px-5 py-3 rounded-xl bg-violet-600 text-white text-sm">Lưu</button>
                </div>
