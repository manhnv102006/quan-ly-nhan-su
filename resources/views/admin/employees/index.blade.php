                                                    ...
                                                    <tr class="border-t border-slate-100 hover:bg-slate-50 transition">
                                                        ...
                                                        <td class="px-6 py-4 text-center">
                                                            <div class="flex items-center justify-center gap-2">
                                                                ...
                                                                <form action="{{ route('admin.employees.delete', $employee->id) }}" method="POST" id="delete-form-{{ $employee->id }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="button" onclick="if(confirm('Xác nhận xóa nhân viên {{ $employee->full_name }}?')) { document.getElementById('delete-form-{{ $employee->id }}').submit(); }" class="w-9 h-9 rounded-lg bg-red-100 text-red-600 hover:bg-red-200">🗑</button>
                                                                </form>
                                                            </div>
                                                        </td>
                                                    </tr>
